ass ImageDataGenerator(object):
    '''Generate minibatches with real-time adversarial training.
    Requires a reference to the model in order to access the loss for the training sample.
    See https://github.com/mihaelacr/pydeeplearn/blob/4cefc4af0e6a50c046abe92f6f57bb962d58e900/code/lib/deepbelief.py as an example
    ...
    def standardize(self, x):
        "Called by the NumpyArrayIterator"
        if self.rescale:
            x *= self.rescale
